...
if __name__ == '__main__':
    ...
    output_ath = AthenaURI(args['outputs']['churn_features'][0]['uri'])
...
SELECT 
  c.CustomerID,
  DATEDIFF(current_date, c.RegistrationDate) AS days_since_registration,
  DATEDIFF(current_date, MAX(ci.InteractionDate)) AS days_since_last_interaction,
